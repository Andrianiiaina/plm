...
final class Version20250318060627 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tender DROP contact_id, DROP submission_date, DROP response_date, DROP attribution_date, DROP negotiation_date, CHANGE status status INT NOT NULL, CHANGE tender_type tender_type INT NOT NULL');
    }
}
