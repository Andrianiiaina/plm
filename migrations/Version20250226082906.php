 ...
 */
final class Version20250226082906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, responsable_id INT DEFAULT NULL, project_id INT NOT NULL, filename VARCHAR(255) NOT NULL, filepath VARCHAR(255) NOT NULL, information LONGTEXT DEFAULT NULL, status VARCHAR(10) NOT NULL, INDEX IDX_D8698A7653C59D72 (responsable_id), INDEX IDX_D8698A76166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
