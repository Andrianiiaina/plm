 ...
 */
final class Version20250305130605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE file ADD CONSTRAINT FK_8C9F36109245DE54 FOREIGN KEY (tender_id) REFERENCES tender (id)');
