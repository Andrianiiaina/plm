 ...
 */
final class Version20250625125950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_42057A77E7A1254A ON tender (contact_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE tender_contact (tender_id INT NOT NULL, contact_id INT NOT NULL, INDEX IDX_A4598A339245DE54 (tender_id), INDEX IDX_A4598A33E7A1254A (contact_id), PRIMARY KEY(tender_id, contact_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('DROP INDEX IDX_42057A77E7A1254A ON tender');
